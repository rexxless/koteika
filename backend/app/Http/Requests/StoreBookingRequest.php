...
class StoreBookingRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'pets.*.required' => 'У каждого питомца должна быть указана кличка.',
            'pets.*.string' => 'Кличка каждого питомца должно быть строкой.',
            'pets.*.max' => 'Кличка питомца не должно превышать 64 символа.',
            'pets.*.regex' => 'Кличка питомца может содержать только буквы, цифры и специальные символы.',
        ];
    }
}
